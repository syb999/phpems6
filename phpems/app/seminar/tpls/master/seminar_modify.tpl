...
{x2;endif}
				...
				<div class="box itembox" style="padding-top:10px;margin-bottom:0px;overflow:visible">
					...
					<form action="index.php?seminar-master-seminar-modify" method="post" class="form-horizontal">
						<div class="form-group">
				            <label for="seminartitle" class="control-label col-sm-2">标题：</label>
				            <div class="col-sm-9">
							    <input class="form-control" type="text" id="seminartitle" name="args[seminartitle]" value="{x2;$seminar['seminartitle']}" needle="needle" msg="您必须输入专题标题">
					        </div>
				        </div>
				        <div class="form-group">
				            <label for="seminartitle" class="control-label col-sm-2">发布时间：</label>
				            <div class="col-sm-4">
							    <input class="form-control datetimepicker" data-minview="0" data-date="{x2;date:TIME,'Y-m-d H:i:s'}" value="{x2;date:$seminar['seminartime'],'Y-m-d H:i:s'}" data-date-format="yyyy-mm-dd hh:ii:ss" type="text" name="args[seminartime]" needle="needle" msg="您必须输入发布时间">
					        </div>
				        </div>
				        <div class="form-group">
						    		...
						    		<div class="qq-uploader-selector" style="width:30%" qq-drop-area-text="可将图片拖拽至此处上传" style="clear:both;">
						            	<div class="qq-upload-button-selector" style="clear:both;">
								            ...
								            <ul class="qq-upload-list-selector list-unstyled" aria-live="polite" aria-relevant="additions removals" style="clear:both;">
									            <li class="text-center">
									                <div class="thumbnail">
														<img class="qq-thumbnail-selector" src="{x2;if:$seminar['seminarthumb']}{x2;$seminar['seminarthumb']}{x2;else}app/core/styles/images/noimage.gif{x2;endif}" alt="点击上传新图片">
														<input type="hidden" class="qq-edit-filename-selector" name="args[seminarthumb]" tabindex="0" value="{x2;if:$seminar['seminarthumb']}{x2;$seminar['seminarthumb']}{x2;else}app/core/styles/images/noimage.gif{x2;endif}">
						                			</div>
									            </li>
									        </ul>
						                </div>
				        ...
				        <div class="form-group">
				            ...
				            <div class="col-sm-9">
							    <input class="form-control" type="text" id="seminarlink" name="args[seminarlink]" value="{x2;$seminar['seminarlink']}">
					        </div>
				        </div>
						<div class="form-group">
							<label for="seminardescribe" class="control-label col-sm-2">摘要：</label>
							<div class="col-sm-9">
								<textarea id="seminardescribe" class="form-control" name="args[seminardescribe]" rows="7" cols="4">{x2;$seminar['seminardescribe']}</textarea>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-10">
								...
								<textarea class="form-control hide blockcontent_content" rows="7" cols="4" name="args[seminarcode]">{x2;$seminar['seminarcode']}</textarea>
				        ...
				        <div class="form-group">
				            ...
				            <div class="col-sm-9">
								...
								<input type="hidden" name="seminarid" value="{x2;$seminar['seminarid']}">
					        </div>
				        </div>
					</form>
				</div>
