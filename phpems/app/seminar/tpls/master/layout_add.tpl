...
{x2;endif}
				...
				<div class="box itembox" style="padding-top:10px;margin-bottom:0px;overflow:visible">
					...
					<form action="index.php?seminar-master-seminar-addlayout" method="post" class="form-horizontal">
						<div class="form-group">
				            <label for="seminartitle" class="control-label col-sm-2">标题：</label>
				            <div class="col-sm-9">
							    <input class="form-control" type="text" name="args[slayouttitle]" needle="needle" msg="您必须输入标题">
					        </div>
				        </div>
						<div class="form-group">
							...
							<div class="col-sm-9">
								<label class="radio-inline">
									<input type="radio" name="args[slayoutgrid]" value="1" checked/> 通栏
								</label>
								<label class="radio-inline">
									<input type="radio" name="args[slayoutgrid]" value="2"/> 左右两栏
								</label>
								<label class="radio-inline">
									<input type="radio" name="args[slayoutgrid]" value="3"/> 左中右三栏
								</label>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-9">
								<textarea id="seminardescribe" class="form-control" name="args[slayoutdescribe]" rows="7" cols="4"></textarea>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-10">
								...
								<textarea class="form-control hide blockcontent_content" rows="7" cols="4" name="args[slayoutcode]"></textarea>
