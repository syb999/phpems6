...
{x2;endif}
				...
				<div class="box itembox" style="padding-top:10px;margin-bottom:0px;overflow:visible">
					<h4 class="title" style="padding:10px;">
						添加{x2;$types[$type]}
						<a class="btn btn-primary pull-right" href="index.php?{x2;$_app}-master-seminar-{x2;$type}">模板管理</a>
					</h4>
					<form action="index.php?seminar-master-tpls-add" method="post" class="form-horizontal">
						<div class="form-group">
							<label for="contenttitle" class="control-label col-sm-2">名称：</label>
							<div class="col-sm-9">
								<input class="form-control" type="text" id="contenttitle" name="args[stplname]" needle="needle" msg="您必须输入名称">
							</div>
						</div>
						<div class="form-group">
											...
											<ul class="qq-upload-list-selector list-unstyled" aria-live="polite" aria-relevant="additions removals" style="clear:both;">
												<li class="text-center">
													<div class="thumbnail">
														...
														<input type="hidden" class="qq-edit-filename-selector" name="args[stplthumb]" tabindex="0" value="app/core/styles/images/noimage.gif">
													</div>
												</li>
											</ul>
										</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<label class="radio-inline">
									<input type="radio" name="args[stplgrid]" value="1" checked/> 通栏
								</label>
								<label class="radio-inline">
									<input type="radio" name="args[stplgrid]" value="2"/> 左右两栏
								</label>
								<label class="radio-inline">
									<input type="radio" name="args[stplgrid]" value="3"/> 左中右三栏
								</label>
							</div>
						</div>
						{x2;endif}
						<div class="form-group">
							...
							<div class="col-sm-9">
								<textarea id="contentdescribe" class="form-control" name="args[stpldescribe]" rows="7" cols="4"></textarea>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-10">
								...
								<textarea class="form-control hide blockcontent_content" rows="7" cols="4" name="args[stplcode]"></textarea>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								...
								<input type="hidden" name="args[stpltype]" value="{x2;$type}">
							</div>
						</div>
					</form>
				</div>
