...
{x2;endif}
				...
				<div class="box itembox" style="padding-top:10px;margin-bottom:0px;overflow:visible">
					...
					<form action="index.php?seminar-master-seminar-modifyelem" method="post" class="form-horizontal">
						<div class="form-group">
				            <label for="seminartitle" class="control-label col-sm-2">标题：</label>
				            <div class="col-sm-9">
							    <input class="form-control" type="text" name="args[seltitle]" value="{x2;$elem['seltitle']}" needle="needle" msg="您必须输入标题">
					        </div>
				        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                <label class="radio-inline">
                                    <input type="radio" name="args[selpos]" value="1"{x2;if:$elem['selpos'] == 1} checked{x2;endif}/> 左栏
                                </label>
                                <label class="radio-inline">
                                    <input type="radio" name="args[selpos]" value="2"{x2;if:$elem['selpos'] == 2} checked{x2;endif}/> 右栏
                                </label>
                                {x2;elseif:$layout['slayoutgrid'] == 3}
                                <label class="radio-inline">
                                    <input type="radio" name="args[selpos]" value="0"{x2;if:$elem['selpos'] == 0} checked{x2;endif}/> 中栏
                                </label>
                                <label class="radio-inline">
                                    <input type="radio" name="args[selpos]" value="1"{x2;if:$elem['selpos'] == 1} checked{x2;endif}/> 左栏
                                </label>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<textarea id="seminardescribe" class="form-control" name="args[seldescribe]" rows="7" cols="4">{x2;$elem['seldescribe']}</textarea>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-10">
								...
								<textarea class="form-control hide blockcontent_content" rows="7" cols="4" name="args[selcode]">{x2;realhtml:$elem['selcode']}</textarea>
