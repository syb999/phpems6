				...
				<div class="box itembox" style="margin-bottom:0px;border-bottom:1px solid #CCCCCC;">
						<div class="col-xs-12">
							<ol class="breadcrumb">
								...
								<li><a href="index.php?{x2;$_app}-master-module">模型管理</a></li>
					...
					<div class="box itembox" style="padding-top:10px;margin-bottom:0px;">
						...
						<form action="index.php?{x2;$_app}-master-module-add" method="post" class="form-horizontal">
							<fieldset>
								...
								<div class="form-group">
									...
									<div class="col-sm-4">
										...
										<span class="help-block">请输入12字以内的英文模型代码，系统将以模型代码为名称建表。</span>
									</div>
								</div>
								<div class="form-group">
