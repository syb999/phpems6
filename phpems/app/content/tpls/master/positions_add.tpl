...
{x2;endif}
				...
				<div class="box itembox" style="padding-top:10px;margin-bottom:0px;">
					...
					<form action="index.php?{x2;$_app}-master-positions-add" method="post" class="form-horizontal">
		    			<fieldset>
		    			<div class="form-group">
							<label for="section" class="control-label col-sm-2">推荐位名称：</label>
							<div class="col-sm-5">
								<input class="form-control" id="section" name="args[posname]" type="text" size="30" value="" needle="needle" msg="请输入章节名称" />
							</div>
						</div>
						<div class="form-group">
