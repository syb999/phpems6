...
{x2;endif}
				...
				<div class="box itembox" style="padding-top:10px;margin-bottom:0px;overflow:visible">
					...
					<form action="index.php?certificate-master-certificate-modify" method="post" class="form-horizontal">
						<div class="form-group">
				            <label for="contenttitle" class="control-label col-sm-2">证书标题：</label>
				            <div class="col-sm-9">
							    <input class="form-control" type="text" id="cetitle" name="args[cetitle]" value="{x2;$ce['cetitle']}" needle="needle" msg="您必须输入标题">
					        </div>
				        </div>
				        <div class="form-group">
				            <label for="contenttitle" class="control-label col-sm-2">加入时间：</label>
				            <div class="col-sm-4">
							    <input class="form-control datetimepicker" data-minview="0" data-date="{x2;date:TIME,'Y-m-d H:i:s'}" data-date-format="yyyy-mm-dd hh:ii:ss" type="text" id="cetime" value="{x2;date:$ce['cetime'],'Y-m-d H:i:s'}" name="args[cetime]" needle="needle" msg="您必须输入发布时间">
					        </div>
				        </div>
				        <div class="form-group">
				            <label for="contenttitle" class="control-label col-sm-2">办证费用：</label>
				            <div class="col-sm-4">
							    <input class="form-control" name="args[ceprice]" value="{x2;$ce['ceprice']}" needle="needle" msg="您必须输入办证费用" placeholder="办证所需积分">
					        </div>
				        </div>
				        <div class="form-group">
				            <label for="contenttitle" class="control-label col-sm-2">需通过的考场ID：</label>
				            <div class="col-sm-4">
							    <input class="form-control" name="args[cebasic]" value="{x2;$ce['cebasic']}" needle="needle" msg="您必须输入需通过的考场ID" placeholder="输入需通过的考场ID">
					        </div>
				        </div>
				        <div class="form-group">
						    		...
						    		<div class="qq-uploader-selector" style="width:30%" qq-drop-area-text="可将图片拖拽至此处上传" style="clear:both;">
						            	<div class="qq-upload-button-selector" style="clear:both;">
								            ...
								            <ul class="qq-upload-list-selector list-unstyled" aria-live="polite" aria-relevant="additions removals" style="clear:both;">
									            <li class="text-center">
									                <div class="thumbnail">
														<img class="qq-thumbnail-selector" src="{x2;$ce['cethumb']}" alt="点击上传新图片">
														<input type="hidden" class="qq-edit-filename-selector" name="args[cethumb]" tabindex="0" value="{x2;$ce['cethumb']}">
						                			</div>
									            </li>
									        </ul>
						                </div>
				        ...
				        <div class="form-group">
				            ...
				            <div class="col-sm-9">
					            ...
					            <input type="hidden" name="modifycertificate" value="1">
