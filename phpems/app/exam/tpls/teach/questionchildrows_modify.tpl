...
{x2;endif}
				<div class="box itembox" style="margin-bottom:0px;border-bottom:1px solid #CCCCCC;">
					<div class="col-xs-12">
						<ol class="breadcrumb">
							...
							<li><a href="index.php?exam-teach-rowsquestions-rowsdetail&questionid={x2;$questionparent}&page={x2;$page}{x2;$u}">子试题列表</a></li>
				...
				<div class="box itembox" style="padding-top:10px;margin-bottom:0px;">
					<h4 class="title" style="padding:10px;">
						修改子试题
						<a class="btn btn-primary pull-right" href="index.php?exam-teach-rowsquestions-rowsdetail&questionid={x2;$questionparent}&page={x2;$page}{x2;$u}">子试题列表</a>
					</h4>
