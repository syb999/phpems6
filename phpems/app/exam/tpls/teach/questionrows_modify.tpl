				...
				<div class="box itembox" style="padding-top:10px;margin-bottom:0px;">
					...
					<form action="?exam-teach-rowsquestions-modifyquestion" method="post" class="form-horizontal">
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<select id="qrtype" class="form-control" needle="needle" msg="您必须为要添加的试题选择一种题型" name="args[qrtype]">
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<select id="qrlevel" class="form-control" name="args[qrlevel]" needle="needle" msg="您必须为要添加的试题设置一个难度">
