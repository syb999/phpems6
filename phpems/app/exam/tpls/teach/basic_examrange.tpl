				...
				<div class="box itembox" style="padding-top:10px;margin-bottom:0px;">
			        ...
			        <form action="?exam-teach-basic-setexamrange" method="post" class="form-horizontal">
						...
						<div class="form-group">
							<label class="control-label col-sm-2">章节选择：<input type="checkbox" onclick="javascript:$('.section:checkbox').prop('checked',$(this).is(':checked'));"> </label>
						</div>
						...
						{x2;endif}
						<div class="form-group">
							<label for="basicexam_auto" class="control-label col-sm-2">考场模式：</label>
							<div class="col-sm-9">
						...
						<div class="form-group">
							<label for="basicexam_auto" class="control-label col-sm-2">正式考试试题排序：</label>
							<div class="col-sm-9">
								<label class="radio-inline">
						...
						<div class="form-group">
							<label for="basicexam_auto" class="control-label col-sm-2">绑定模拟考试试卷：</label>
							<div class="col-sm-9 form-inline">
								<input size="50" class="form-control" type="text" id="basicexam_auto" name="args[basicexam][auto]" needle="needle" msg="您必须填写至少一个试卷" value="{x2;$basic['basicexam']['auto']}" /> <a class="selfmodal btn btn-primary" href="javascript:;" data-target="#modal" url="index.php?exam-teach-exams-selectexams&search[subjectid]={x2;$basic['basicsubjectid']}&exams={basicexam_auto}&useframe=1&target=basicexam_auto" valuefrom="basicexam_auto">选卷</a>
								<span class="help-block">请在试卷管理处查看试卷ID，将数字ID填写在这里，多个请用英文逗号（,）隔开。留空或填0时将无法进行该项考试。</span>
							</div>
						</div>
						<div class="form-group">
							<label for="basicexam_autotemplate" class="control-label col-sm-2">模拟考试模板：</label>
							<div class="col-sm-3">
						...
						<div class="form-group">
							<label for="basicexam_self" class="control-label col-sm-2">绑定正式考试试卷：</label>
							<div class="col-sm-9 form-inline">
								<input size="50" class="form-control" type="text" id="basicexam_self" name="args[basicexam][self]" needle="needle" msg="您必须填写至少一个试卷" value="{x2;$basic['basicexam']['self']}" /> <a class="selfmodal btn btn-primary" href="javascript:;" data-target="#modal" url="index.php?exam-teach-exams-selectexams&search[subjectid]={x2;$basic['basicsubjectid']}&exams={basicexam_self}&useframe=1&target=basicexam_self" valuefrom="basicexam_self">选卷</a>
								<span class="help-block">请在试卷管理处查看试卷ID，将数字ID填写在这里，多个请用英文逗号（,）隔开。留空或填0时将无法进行该项考试。</span>
							</div>
						</div>
						<div class="form-group">
							<label for="basicexam_selftemplate" class="control-label col-sm-2">正式考试试卷模板：</label>
							<div class="col-sm-3">
						...
						<div class="form-group">
							<label class="control-label col-sm-2">正式考试开启时间：</label>
							<div class="col-sm-9 form-inline">
						...
						<div class="form-group">
							<label class="control-label col-sm-2">正式考试抽卷规则：</label>
							<div class="col-sm-9">
								<label class="radio-inline">
						...
						<div class="form-group">
							<label class="control-label col-sm-2">正式考试限考次数：</label>
						...
						<div class="form-group">
							<label for="basicexam_auto" class="control-label col-sm-2">交卷后：</label>
							<div class="col-sm-9">
								<label class="radio-inline">
