...
<div class="pages">
	...
	<div class="page-tabs">
		<div class="page-header">
			...
			<div class="col-8">考试记录（{x2;if:$ehtype == 0}强化训练{x2;elseif:$ehtype == 1}模拟考试{x2;elseif:$ehtype == 2}正式考试{x2;endif}）</div>
		...
		<div class="page-content header{x2;if:$exams['pages']} footer{x2;endif}">
			<div class="list-box bg">
				<ol>
					...
					<a href="index.php?exam-phone-history-stats&ehid={x2;v:exam['ehid']}" class="ajax">
					<li class="unstyled">
						<div class="col-8x">
